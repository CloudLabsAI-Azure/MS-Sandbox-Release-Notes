# Project-ready - Drive Agentic AI Conversations with Copilot Cowork & Copilot Studio

Welcome to the **Project-ready - Drive Agentic AI Conversations with Copilot Cowork & Copilot Studio** Release Notes. In this page, we will document the changes made during the last testing cycle.
...
- Updated navigation flows across all labs to consistently reference Microsoft 365 Copilot portal (`https://m365.cloud.microsoft/chat/`) as the primary entry point.
- Standardized Copilot Studio access patterns with updated portal URLs (`https://copilotstudio.microsoft.com/`).
- Improved authentication flow documentation to account for "Stay signed in?" prompt behavior across all labs.
- Enhanced SharePoint site creation guidance with improved unique naming strategy using random 4-digit suffixes to prevent site name conflicts.
- Refined browser navigation instructions to consistently reference "On your virtual machine, open a browser" pattern for clarity.

### Content Changes

**Lab 1 - Email Triage Agent with Workflows (Frontier):**
- Updated agent discovery navigation from "All Agents" to "Agents > More agents" path for accessing Agent Store.
- Added troubleshooting note for workflow test failures: "If you receive any error, refresh the browser tab, save your changes again, and then rerun the test."
- Improved email validation requirements with explicit notes about sending test emails for workflow verification.
...
- Added "Stay signed in?" dialog handling instructions.
- Enhanced authentication workflow documentation with proper screenshot guidance.
- Updated image generation screenshot reference.
- Updated contextual action toolbar references.
- Improved prompt formatting consistency for image and video generation exercises.
- Removed unnecessary italics and formatting inconsistencies in multi-line prompts.

### Testing Notes

- **Testing Date**: 2026-08-25

### Testing Scope 

Successfully completed comprehensive lab testing across all five project-ready labs. Thoroughly reviewed and validated:
- Email triage agent creation and Workflows (Frontier) configuration
- Microsoft 365 Copilot intelligence layer integration
- SharePoint site creation with improved naming conflict resolution
- File classification and governance workflows
- Multi-agent orchestration and security posture
- Content creation with Designer and Editor features
- End-to-end user workflows across all exercise scenarios
- Authentication and sign-in procedures
