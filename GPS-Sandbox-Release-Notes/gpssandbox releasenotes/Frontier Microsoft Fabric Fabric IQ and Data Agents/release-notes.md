# Frontier Microsoft Fabric: Fabric IQ and Data Agents

Welcome to the **Frontier Microsoft Fabric: Fabric IQ and Data Agents** Readme.md . In this page, we will document the changes made during the last testing cycle, including updates related to the infrastructure, content, screenshots, bug fixes, and other relevant changes for the lab.
