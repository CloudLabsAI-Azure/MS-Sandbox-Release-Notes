...
- **Minor updates**: Minor screenshot updates.
...
Updated inject keys which were not configured properly.
...
This update includes minor enhancements, including improved UI screenshots and refined instructions to provide greater clarity and accuracy.
...
- **Minor updates**: 
    ...
    - **Updated UI Screenshots**: The screenshots have been updated to reflect the most recent changes in the user interface.
