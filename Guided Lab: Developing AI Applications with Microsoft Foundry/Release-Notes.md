# Guided Lab: Developing AI Applications with Microsoft Foundry

Welcome to the **Guided Lab: Developing AI Applications with Microsoft Foundry** Readme.md . In this page, we will document the changes made during the last testing cycle, including updates related to the infrastructure, content, screenshots, bug fixes, and other relevant changes for the lab.
