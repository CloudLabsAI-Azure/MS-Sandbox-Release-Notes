...
Welcome to the **Building a Multimodal RAG Solution with Copilot Studio** release notes. On this page, we will document the changes made during the last testing cycle, including updates related to the infrastructure, content, screenshots, and other relevant changes for the lab.
